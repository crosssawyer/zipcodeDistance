...
public class Project01 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (validateZip(zipcode) != true) { // while loop to run check to validate zipCode, checks is num, length and
                                               // not null
            System.out.print("What zip code are you interested in? ");
    ...
    public static void showMatches(String targetCoordinates, Scanner input, double miles) throws FileNotFoundException {
        ...
        while (input.hasNext()) {
            for (int x = 0; x < fulllist.length; x++) { // for loop to iterate through each line of file, while
    ...
    public static double distance(double lat1, double long1, double lat2, double long2) { // method to convert lats and
                                                                                          // longs of target cords and
                                                                                          // cords within the files to
                                                                                          // usable distances
    ...
    public static String findMaxDistance(String zip, String city, double distance) { // method that compares distance to
                                                                                     // current max to find the farthest
                                                                                     // location
